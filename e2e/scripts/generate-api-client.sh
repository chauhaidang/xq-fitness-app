...
echo ""
echo -e "${BLUE}To use in e2e tests, the dependency is already in mobile/package.json:${NC}"
echo -e "${YELLOW}  \"${PACKAGE_NAME}\": \"file:./e2e/generated-clients/${SERVICE_NAME}\"${NC}"
echo ""
echo -e "${BLUE}Run: cd mobile && yarn install${NC}"
